...
Todo.Template.Edit.prototype.render_ = function(sb, context, blocks) {
    ...
    sb.append("\" \/>\n                    <p class=\"help-block\">The title of the todo<\/p>\n                <\/div>\n            <\/div>\n        <\/div>\n\n    <\/fieldset>\n\n    <div class=\"form-actions\" id=\"form-actions\">\n        <a class=\"btn save-btn\">Save<\/a>\n        <a class=\"btn back-btn\">Cancel<\/a>\n    <\/div>\n<\/form>\n");
};
...
Todo.Template.TodoList.prototype.render_ = function(sb, context, blocks) {
    ...
    twig.forEach(seq, function(v, k) {
        ...
        if (((0) == (twig.attr("todo" in context ? context["todo"] : null, "is_finished")))) {
            // line 23
            sb.append("                    <a class=\"btn btn-success finish\">\n                        <i class=\"icon-check\"><\/i> <span class=\"hide\">Delete<\/span>\n                    <\/a>\n                ");
        } else {
            // line 27
            sb.append("                    Done!\n                ");
        }
        // line 29
        sb.append("            <\/td>\n            <td>\n                <a class=\"btn btn-danger delete\">\n                    <i class=\"icon-trash icon-white\"><\/i> <span class=\"hide\">Delete<\/span>\n                <\/a>\n            <\/td>\n        <\/tr>\n    ");
    }, this);
    // line 37
    sb.append("    <\/tbody>\n<\/table>\n\n\n");
};
